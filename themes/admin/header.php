         ...
         <div id="wrapper">
            <div id="user">
               <img src="images/user/userPic.png"> 
                  <span><?php echo lang("Hoşgeldiniz").", ".$this->session->userdata("user_adsoyad")."!" ?></span>
            </div>
            <div id="topmenu">
               <ul>
                  <li><a href="<?= base_url() ?>admin/account"><img src="images/topnav/profile.png"><span><?php echo lang("Profilim") ?></span></a></li>
                  <li><a href="<?= base_url() ?>admin/yapilacaklar"><img src="images/topnav/tasks.png"><span><?php echo lang("Yapılacaklar") ?></span></a></li>
                  <li><a href="<?= base_url() ?>"><img src="images/topnav/messages.png"><span><?php echo lang("Mesajlarım") ?></span></a></li>
