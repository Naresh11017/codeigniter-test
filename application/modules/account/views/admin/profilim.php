   ...
   <div class="block">
      ...
      <div style="padding:10px;">
         ...
         <table width="100%" cellpadding="5" cellspacing="0" class="formTable">
            ...
            <tr>
               <td width="30%"><b><?php echo lang("Adınız Soyadınız"); ?></b></td>
               <td width="5%">:</td>
               <td><?php echo $data->adsoyad ?></td>
            </tr>
            <tr>
               <td width="30%"><b><?php echo lang("Kullanıcı Grubu"); ?></b></td>
               <td width="5%">:</td>
               <td><?php echo $data->belonggroup ?> <span class="smalldesc">(Bu değişecek grupları yapınca..)</span></td>
            </tr>
            <tr>
               <td><b><?php echo lang("Üyelik Tarihi"); ?></b></td>
               <td>:</td>
               <td><?php echo dateFormat($data->uyeliktarihi,"long") ?></td>
            </tr>
            <tr>
               <td><b><?php echo lang("Sisteme Son Giriş Tarihi"); ?></b></td>
               <td>:</td>
